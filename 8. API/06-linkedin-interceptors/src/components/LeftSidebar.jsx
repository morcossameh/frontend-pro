...
function LeftSidebar() {
  ...
  const userName = currentUser
    ...
    : "User";
  const userHeadline = currentUser?.headline || "LinkedIn User";
    ...
    <aside className="flex flex-col gap-2">
      <div className="card overflow-hidden relative">
        ...
        <div className="px-3 pb-4 text-center">
          ...
          />
          <h2 className="pt-10 text-base font-bold mb-0.5">{userName}</h2>
          <p className="text-small-neutral mb-1">{userHeadline}</p>
        </div>
