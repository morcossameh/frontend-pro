import { useEffect, useMemo, useRef, useState, type Dispatch, type SetStateAction, type SubmitEvent } from "react";
...
function TodoRow({ todo, setTodos }: TodoRowProps) {
  const toggleTodo = () => {
    setTodos((prev) =>
      prev.map((t) =>
...
export default function App() {
  ...
  const [filter, setFilter] = useState<filters>("all"); // all | active | completed
